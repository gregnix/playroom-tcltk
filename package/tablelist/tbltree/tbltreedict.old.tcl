...
if {0} {
    ...
    proc setSourceIndex {W x y} {
        ...
        dict set $state $tbl mouse beforebg [$tbl rowcget [dict get $state $tbl mouse sourceIndex] -bg]"
        $tbl rowconfigure [dict get $state $tbl mouse sourceIndex] -bg red
    ...
    proc moveElement {W x y} {
        ...
        if {[dict get $state $tbl mouse sourceIndex] != -1} {
            ...
            if {$newIndex != [dict get $state $tbl mouse sourceIndex]} {
                ...
                $tbl rowconfigure [expr {$newIndex -1}] -bg blue
                $tbl selection clear 0 end
