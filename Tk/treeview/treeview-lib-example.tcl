...
proc buttonbar {w tree textw} {
  ...
  button $cf.b28 -text "getRow sel" -command [list cbbtnbar $tree {$textw insert end [tvlib::getGlobalIndex $tree [$tree selection]]\n}]
  button $cf.b29 -text "BuildChildCountDict" -command [list cbbtnbar $tree {$textw insert end [tvlib::buildChildCountDict $tree]\n}]
  button $cf.b30 -text "GlobalIndex" -command [list cbbtnbar $tree {$textw insert end [tvlib::getGlobalIndexFromDict $tree [$tree selection] [tvlib::buildChildCountDict $tree]]\n}]
  button $cf.b31 -text "index sel" -command [list cbbtnbar $tree {$textw insert end [$tree index [$tree selection]]\n}]
  button $cf.b32 -text "ctext clean" -command [list cbbtnbar $tree {$textw delete 4.0 end}]
