...
namespace eval ::tclfpdf:: {
	...
	variable TCLFPDF_USER_FONTPATH "[file join /tmp TCFPDF fontuser]"
	...
	variable fontuserpath                	;# path containing user fonts
...
proc ::tclfpdf::AddFont { family {style ""} {file ""} {uni 0}} {
	variable fonts; variable FontFiles; variable SYSTEM_TTFONTS; variable fontpath; variable fontuserpath; variable AliasNbPages;
	...
	if  {$uni } {
		...
		set unifilename "$fontuserpath/[string tolower [file rootname $file]]";
		set name "";
		set originalsize 0;
